<template>
    ...
    <div style="background: #2e2e36;" class="container  input-box right p-5 mt-4 mb-5 fs-5">
      <h1 class="display-6 text-light text-center mt-4 mb-5 ps-3 pe-3">Wypełnij pola, by dodać do stworzonej rasy cechy</h1>
 ...
 methods: {
  clearFields() {
      ...
      if (isFormCorrect) 
    {
        ...
        axios.post('https://localhost:7095/api/CustomRaceFeature?raceId=' + this.raceID, this.raceFeature, {
                            headers: {
