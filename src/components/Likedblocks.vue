    ...
    <div class="container-fluid">
        <div class="row">
            <h1 data-aos="fade-right"
                ...
                class="display-6 text-light text-center mt-5">Wybierz kategorie, w której chcesz przejrzeć swoje polubione elementy:</h1></div>
        <div class="row justify-content-center">
            <div data-aos="fade-up"
                 ...
                 data-aos-once="true"
                 data-aos-anchor-placement="top-center"
                 class="col-lg-1 col-md-6 col-sm-12 mt-3 mt-lg-5 lg-box ms-xl-1 ms-lg-3">
                <router-link style="text-decoration: none" to="/PolubioneCzary">
            ...
            <div data-aos="fade-down"
                 ...
                 data-aos-once="true"
                 data-aos-anchor-placement="top-center"
                class="col-lg-1 col-md-6 col-sm-12 mt-3 mt-lg-5 lg-box ms-xl-3 ms-lg-3">
                <router-link style="text-decoration: none" to="/PolubieniPrzeciwnicy">
                    <div class="card p-4 bg-white">
                        <div class="d-none d-lg-block text-center">
            ...
            <div data-aos="fade-up"
                 ...
                 data-aos-anchor-placement="top-center"
                class="col-lg-1 col-md-6 col-sm-12 mt-3 mt-lg-5 lg-box ms-xl-3 ms-lg-3">
                <router-link style="text-decoration: none" to="/PolubionePrzedmioty">
                    <div class="card p-4 bg-white">
                        <div class="d-none d-lg-block text-center">
            ...
            <div data-aos="fade-down"
                 ...
                 data-aos-anchor-placement="top-center"
                class="col-lg-1 col-md-6 col-sm-12 mt-3 mt-lg-5 lg-box ms-xl-3 ms-lg-3">
                <router-link style="text-decoration: none" to="/PolubioneRasy">
                    <div class="card p-4 bg-white">
                        <div class="d-none d-lg-block text-center">
            ...
            <div data-aos="fade-up"
                 ...
                 data-aos-anchor-placement="top-center"
                class="col-lg-1 col-md-6 col-sm-12 mt-3 mt-lg-5 lg-box ms-xl-3 ms-lg-3">
                <router-link style="text-decoration: none" to="/PolubionePodrasy">
                    <div class="card p-4 bg-white">
                        <div class="d-none d-lg-block text-center">
            ...
            <div data-aos="fade-down"
                 ...
                 data-aos-anchor-placement="top-center"
                class="col-lg-1 col-md-6 col-sm-12 mt-3 mt-lg-5 lg-box ms-xl-3 ms-lg-3">
                <router-link style="text-decoration: none" to="/PolubioneKlasy">
                    <div class="card p-4 bg-white">
                        <div class="d-none d-lg-block text-center">
            ...
            <div data-aos="fade-up"
                ...
                <router-link style="text-decoration: none" to="/PolubionePodklasy">
                    <div class="card p-4 bg-white">
                        <div class="d-none d-lg-block text-center">
